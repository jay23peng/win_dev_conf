...
- link chrome folder: (profile folder info is in menu/help/More Troubleshooting Information)
  #+begin_src sh
  ln -s ~/u/dex/config/opt/firefox/chrome ~/Library/Application\ Support/Firefox/Profiles/ycqax19j.default-release/chrome
  #+end_src
...
* BOOX Nova3
** bootstrap
- factory reset with cache partition clean.
- install magisk.
- patch boot.img for corresponding firmware.
- adb reboot bootloader
- fastboot boot ./magisk_patched-23000_YjOSI.img
