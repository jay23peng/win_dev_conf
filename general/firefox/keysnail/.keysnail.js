...
key.setViewKey([['C-n'], ['k']], function (ev) {
    key.generateKey(ev.originalTarget, KeyEvent.DOM_VK_DOWN, true);
}, 'Scroll line down');

key.setViewKey([['C-p'], ['j']], function (ev) {
...
key.setEditKey([['C-x', 'v'], ['C-y']], command.yank, 'Paste (Yank)');

key.setEditKey([['C-x', 'C-v'], ['C-@']], function (ev) {
    command.setMark(ev);
}, 'Set the mark', true);
...
key.setCaretKey([['C-n'], ['k']], function (ev) {
    ev.target.ksMarked ? goDoCommand("cmd_selectLineNext") : goDoCommand("cmd_scrollLineDown");
}, 'Move caret to the next line');

key.setCaretKey([['C-p'], ['j']], function (ev) {
...
key.setCaretKey([['C-x', 'C-v'], ['C-@']], function (ev) {
    command.setMark(ev);
}, 'Set the mark', true);
